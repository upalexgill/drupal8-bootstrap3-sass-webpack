...
!(function (t) {
    ...
    (n.fn.emulateTransitionEnd = function (t) {
      ...
      n(() => {
        (n.support.transition = (function o() {
          let t = document.createElement("bootstrap"),
            e = {
          ...
          for (const i in e) if (t.style[i] !== undefined) return { end: e[i] };
          return !1;
        })()),
    ...
    function i(o) {
      return this.each(function () {
        ...
        e || t.data("bs.button", (e = new n(this, i))),
          o == "toggle" ? e.toggle() : o && e.setState(o);
      });
    }
    (n.VERSION = "3.4.1"),
      ...
      (n.prototype.setState = function (t) {
        let e = "disabled",
          ...
          n = i.data();
        (t += "Text"),
          n.resetText == null && i.data("resetText", i[o]()),
          setTimeout(
            s.proxy(function () {
              i[o](n[t] == null ? this.options[t] : n[t]),
                t == "loadingText"
                  ? ((this.isLoading = !0),
    ...
    (s.fn.button = i),
      ...
      s(document)
        .on("click.bs.button.data-api", '[data-toggle^="button"]', (t) => {
          const e = s(t.target).closest(".btn");
          i.call(e, "toggle"),
  ...
  (function (p) {
    ...
    (c.VERSION = "3.4.1"),
      ...
      (c.prototype.getItemForDirection = function (t, e) {
        const i = this.getItemIndex(e);
        if (
          ((t == "prev" && i === 0) ||
            (t == "next" && i == this.$items.length - 1)) &&
          !this.options.wrap
        )
          return e;
        const o = (i + (t == "prev" ? -1 : 1)) % this.$items.length;
      ...
      (c.prototype.slide = function (t, e) {
        let i = this.$element.find(".item.active"),
        ...
        if ((this.$element.trigger(l), !l.isDefaultPrevented())) {
          if (
            ...
            const h = p(this.$indicators.children()[this.getItemIndex(o)]);
            h && h.addClass("active");
          }
          const d = p.Event("slid.bs.carousel", {
            relatedTarget: r,
            direction: s,
          });
          return (
            p.support.transition && this.$element.hasClass("slide")
              ? (o.addClass(t),
                typeof o === "object" && o.length && o[0].offsetWidth,
                i.addClass(s),
                o.addClass(s),
                i
                  .one("bsTransitionEnd", () => {
    ...
    const e = function (t) {
      let e = p(this),
        i = e.attr("href");
      i && (i = i.replace(/.*(?=#[^\s]+$)/, ""));
      let o = e.attr("data-target") || i,
        n = p(document).find(o);
      if (n.hasClass("carousel")) {
        let s = p.extend({}, n.data(), e.data()),
  ...
  (function (a) {
    ...
    function l(o) {
      return this.each(function () {
        let t = a(this),
          ...
          i = a.extend({}, r.DEFAULTS, t.data(), typeof o === "object" && o);
    ...
    (r.VERSION = "3.4.1"),
      ...
      (r.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            ...
            const i = a.Event("show.bs.collapse");
            if ((this.$element.trigger(i), !i.isDefaultPrevented())) {
              e &&
                e.length &&
                (l.call(e, "hide"), t || e.data("bs.collapse", null));
              const o = this.dimension();
              this.$element
              ...
              const s = a.camelCase(["scroll", o].join("-"));
              this.$element
      ...
      (r.prototype.hide = function () {
        if (!this.transitioning && this.$element.hasClass("in")) {
          const t = a.Event("hide.bs.collapse");
      ...
      (r.prototype.addAriaAndCollapsedClass = function (t, e) {
        const i = t.hasClass("in");
        t.attr("aria-expanded", i),
          e.toggleClass("collapsed", !i).attr("aria-expanded", i);
      });
    const t = a.fn.collapse;
    (a.fn.collapse = l),
  ...
  (function (a) {
    let r = '[data-toggle="dropdown"]',
      o = function (t) {
        a(t).on("click.bs.dropdown", this.toggle);
      };
    function l(t) {
      let e = t.attr("data-target");
      e ||
        (e =
          (e = t.attr("href")) &&
          /#[A-Za-z]/.test(e) &&
          e.replace(/.*(?=#[^\s]*$)/, ""));
      const i = e !== "#" ? a(document).find(e) : null;
        ...
        if (
          ...
          if (
            ...
            if ((!o && t.which != 27) || (o && t.which == 27))
              return (
                t.which == 27 && i.find(r).trigger("focus"), e.trigger("click")
              );
            const n = i.find(".dropdown-menu li:not(.disabled):visible a");
            if (n.length) {
              let s = n.index(t.target);
              t.which == 38 && s > 0 && s--,
                t.which == 40 && s < n.length - 1 && s++,
                ~s || (s = 0),
  ...
  (function (a) {
    ...
    function r(o, n) {
      return this.each(function () {
        let t = a(this),
          e = t.data("bs.modal"),
          i = a.extend({}, s.DEFAULTS, t.data(), typeof o === "object" && o);
        e || t.data("bs.modal", (e = new s(this, i))),
          typeof o === "string" ? e[o](n) : i.show && e.show(n);
      });
    }
    (s.VERSION = "3.4.1"),
        ...
        this.$element.trigger(t),
          this.isShown ||
            ...
            this.$dialog.on("mousedown.dismiss.bs.modal", () => {
              o.$element.one("mouseup.dismiss.bs.modal", (t) => {
                a(t.target).is(o.$element) && (o.ignoreBackdropClick = !0);
              });
            }),
            this.backdrop(() => {
              const t = a.support.transition && o.$element.hasClass("fade");
              o.$element.parent().length || o.$element.appendTo(o.$body),
                ...
                o.enforceFocus();
              const e = a.Event("shown.bs.modal", { relatedTarget: i });
              t
                ? o.$dialog
                    .one("bsTransitionEnd", () => {
      ...
      (s.prototype.backdrop = function (t) {
        ...
        if (this.isShown && this.options.backdrop) {
          const o = a.support.transition && i;
          if (
      ...
      (s.prototype.resetScrollbar = function () {
        this.$body.css("padding-right", this.originalBodyPad),
          a(this.fixedContent).each((t, e) => {
            const i = a(e).data("padding-right");
      ...
      a(document).on(
        ...
        function (t) {
          ...
          e.is("a") && t.preventDefault(),
            n.one("show.bs.modal", (t) => {
              t.isDefaultPrevented() ||
                n.one("hidden.bs.modal", () => {
  ...
  (function (g) {
    let o = ["sanitize", "whiteList", "sanitizeFn"],
      a = [
        "background",
        "cite",
        "href",
    ...
    function u(t, e) {
      ...
      for (
        let o = g(e).filter((t, e) => e instanceof RegExp), n = 0, s = o.length;
        n < s;
        n++
      )
    ...
    function n(t, e, i) {
      ...
      if (
        ...
        return t;
      const o = document.implementation.createHTMLDocument("sanitization");
      o.body.innerHTML = t;
      for (
        let n = g.map(e, (t, e) => e),
          s = g(o.body).find("*"),
    ...
    (m.VERSION = "3.4.1"),
      ...
      (m.prototype.init = function (t, e, i) {
        ...
        for (let o = this.options.trigger.split(" "), n = o.length; n--; ) {
          const s = o[n];
          if (s == "click")
            this.$element.on(
              `click.${this.type}`,
            ...
            let a = s == "hover" ? "mouseenter" : "focusin",
              r = s == "hover" ? "mouseleave" : "focusout";
            this.$element.on(
              `${a}.${this.type}`,
              this.options.selector,
      ...
      (m.prototype.getOptions = function (t) {
        ...
        for (const i in e)
          e.hasOwnProperty(i) && g.inArray(i, o) !== -1 && delete e[i];
        return (
      ...
      (m.prototype.enter = function (t) {
        ...
        if (
          ...
          t instanceof g.Event &&
            (e.inState[t.type == "focusin" ? "focus" : "hover"] = !0),
          e.tip().hasClass("in") || e.hoverState == "in")
        )
          e.hoverState = "in";
        else {
          if (
      ...
      (m.prototype.isInStateTrue = function () {
        for (const t in this.inState) if (this.inState[t]) return !0;
        return !1;
      }),
      (m.prototype.leave = function (t) {
        ...
        if (
          (e ||
            ...
            g(t.currentTarget).data(`bs.${this.type}`, e)),
          t instanceof g.Event &&
            (e.inState[t.type == "focusout" ? "focus" : "hover"] = !1),
          !e.isInStateTrue())
        ) {
          if (
            (clearTimeout(e.timeout),
      ...
      (m.prototype.show = function () {
        const t = g.Event(`show.bs.${this.type}`);
        if (this.hasContent() && this.enabled) {
          ...
          if (r) {
            ...
            (s =
              s == "bottom" && l.bottom + d > c.bottom
                ? "top"
                : s == "top" && l.top - d < c.top
                ? "bottom"
                : s == "right" && l.right + h > c.width
                ? "left"
                : s == "left" && l.left - h < c.left
                ? "right"
                : s),
              o.removeClass(p).addClass(s);
          }
          const f = this.getCalculatedOffset(s, l, h, d);
      ...
      (m.prototype.applyPlacement = function (t, e) {
        ...
        isNaN(s) && (s = 0),
          ...
          i.addClass("in");
        let r = i[0].offsetWidth,
          l = i[0].offsetHeight;
        e == "top" && l != n && (t.top = t.top + n - l);
        const h = this.getViewportAdjustedDelta(e, t, r, l);
        h.left ? (t.left += h.left) : (t.top += h.top);
        let d = /top|bottom/.test(e),
      ...
      (m.prototype.fixTitle = function () {
        ...
        (t.attr("title") ||
          typeof t.attr("data-original-title") !== "string") &&
          t
      ...
      (m.prototype.getPosition = function (t) {
        ...
        let n = window.SVGElement && e instanceof window.SVGElement,
      ...
      (m.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
        const n = { top: 0, left: 0 };
        if (!this.$viewport) return n;
        let s = (this.options.viewport && this.options.viewport.padding) || 0,
          a = this.getPosition(this.$viewport);
        if (/right|left/.test(t)) {
          let r = e.top - s - a.scroll,
      ...
      (m.prototype.getTitle = function () {
        ...
        return (
          ...
          (typeof e.title === "function" ? e.title.call(t[0]) : e.title)
        );
      }),
      ...
      (m.prototype.tip = function () {
        if (
          !this.$tip &&
          ((this.$tip = g(this.options.template)), this.$tip.length != 1)
        )
          throw new Error(
  ...
  (function (n) {
    ...
    (s.VERSION = "3.4.1"),
      ...
      (s.prototype.setContent = function () {
        ...
        if (this.options.html) {
          ...
          this.options.sanitize &&
            ...
            o === "string" && (i = this.sanitizeHtml(i))),
      ...
      (s.prototype.getContent = function () {
        ...
        return (
          t.attr("data-content") ||
          (typeof e.content === "function" ? e.content.call(t[0]) : e.content)
        );
      }),
      (s.prototype.arrow = function () {
        return (this.$arrow = this.$arrow || this.tip().find(".arrow"));
      });
    const t = n.fn.popover;
  ...
  (function (s) {
    ...
    (n.VERSION = "3.4.1"),
      ...
      (n.prototype.activate = function (t) {
        ...
        let e = `${this.selector}[data-target="${t}"],${this.selector}[href="${t}"]`,
    ...
    const t = s.fn.scrollspy;
    (s.fn.scrollspy = e),
      (s.fn.scrollspy.Constructor = n),
      (s.fn.scrollspy.noConflict = function () {
        return (s.fn.scrollspy = t), this;
      }),
      s(window).on("load.bs.scrollspy.data-api", () => {
  ...
  (function (l) {
    ...
    (h.VERSION = "3.4.1"),
      ...
      (h.prototype.getState = function (t, e, i, o) {
        let n = this.$target.scrollTop(),
          s = this.$element.offset(),
          a = this.$target.height();
        if (i != null && this.affixed == "top") return n < i && "top";
        if (this.affixed == "bottom")
          return i != null
            ? !(n + this.unpin <= s.top) && "bottom"
            : !(n + a <= t - o) && "bottom";
        let r = this.affixed == null,
          l = r ? n : s.top;
        return i != null && n <= i
          ? "top"
          : o != null && t - o <= l + (r ? a : e) && "bottom";
      }),
      ...
      (h.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
          ...
          typeof e !== "object" && (o = i = e),
            typeof i === "function" && (i = e.top(this.$element)),
            typeof o === "function" && (o = e.bottom(this.$element));
          const s = this.getState(n, t, i, o);
          if (this.affixed != s) {
      ...
      l(window).on("load", () => {
        l('[data-spy="affix"]').each(function () {
          let t = l(this),
            e = t.data();
          (e.offset = e.offset || {}),
            e.offsetBottom != null && (e.offset.bottom = e.offsetBottom),
            e.offsetTop != null && (e.offset.top = e.offsetTop),
            i.call(t, e);
        });
      });
  })(jQuery);
